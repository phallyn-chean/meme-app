class MemeModels {
  ...
  MemeModels({this.success, this.data});

  MemeModels.fromJson(Map<String, dynamic> json) {
...
class Memes {
  ...
  Memes({this.id, this.name, this.url, this.width, this.height, this.boxCount, this.captions});
